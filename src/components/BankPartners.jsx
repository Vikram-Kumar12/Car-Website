...
const BankPartners = () => {
  ...
  const nextBanks = () => {
    setCurrentIndex((prevIndex) => 
      (prevIndex + banksPerView) % totalBanks
    );
  };

  const prevBanks = () => {
    setCurrentIndex((prevIndex) => 
      (prevIndex - banksPerView + totalBanks) % totalBanks
    );
  };
      ...
      <div className="container mx-auto px-4">
          ...
          >
            {[...bankPartners, ...bankPartners].map((bank, index) => (
              ...
              >
                ...
                />
                <h3 className="font-semibold text-center">{bank.name}</h3>
                <p className="text-sm text-gray-600 mt-1 text-center">Interest: {bank.interestRate}%</p>
              </motion.div>
            ))}
          </div>
        )}
        ...
        {showAllBanks && (
          <motion.div
            ...
            className="mt-8"
          >
            <div className={`flex flex-wrap justify-center gap-4 py-5  ${isMobile ? 'px-4' : ''}`}>
